  ...
  def create
    ...
    respond_to do |format|
      if @order_status.save
        format.html { redirect_to(@order_status, :notice => 'OrderStatus was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @order_status.update_attributes(params[:order_status])
        format.html { redirect_to(@order_status, :notice => 'OrderStatus was successfully updated.') }
        format.xml  { head :ok }
      else
